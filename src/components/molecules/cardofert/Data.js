 export const Data = [
    {
      ...
      stars: 4,
      description: "Hôtel moderne en bord de mer avec vues superbes sur la Méditerranée. Confort et élégance garantis.",
      price: '204€ / nuit',
    ...
    },
    {
      ...
      stars: 5,
      description: 'Hôtel de luxe avec vues spectaculaires sur la caldeira et suites élégantes.',
      price: '180€ / nuit',
...

    {
        ...
        hotel: 'Bless Hotel',
        stars: 4,
        description: "Hôtel chic en bord de mer offrant luxe, style et vues imprenables sur la Méditerranée.",
        price: '265€ / nuit',
